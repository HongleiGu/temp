...
export default function EventModalPage({ event, onClose }: EventModalProps) {
	...
	return (
		<div className="relative w-full h-full inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
			<div
				ref={modalRef}
