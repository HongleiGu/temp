        ...
        >
            ...
            <div className="relative z-10 text-center text-white max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    ...
                    {/* Connection Section */}
                    <div>
                        <img src="/images/about/connection-icon.png" alt="Connection Icon" className="w-24 h-24 bg-gray-500 rounded-full mx-auto mb-6" />
                    ...
                    <div>
                        <img src="/images/about/collaboration-icon.png" alt="Connection Icon" className="w-24 h-24 bg-gray-500 rounded-full mx-auto mb-6" />
                    ...
                    {/* Careers Section */}
                    <div>
                        <img src="/images/about/careers-icon.png" alt="Connection Icon" className="w-24 h-24 bg-gray-500 rounded-full mx-auto mb-6" />
