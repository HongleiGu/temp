            ...
            <div className="relative z-10 text-left text-white max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-10">
                    ...
                    <div className="bg-black bg-opacity-50 p-2 text-center">
                        ...
                        <p className="text-xl text-gray-300 pb-10">Communications and Events Director</p>
                    </div>
                    ...
                    <div className="bg-black bg-opacity-50 p-2 text-center">
                        ...
                        <p className="text-xl text-gray-300 pb-10">Outreach and Strategy Manager</p>
                    </div>
                    ...
                    <div className="bg-black bg-opacity-50 p-2 text-center">
                        ...
                        <p className="text-xl text-gray-300 pb-10">Market Analyst</p>
                    </div>
                    {/* Team Member 1 */}
                    <div className="bg-black bg-opacity-50 p-2 text-center">
                        ...
                        <p className="text-xl text-gray-300 pb-10">Multimedia Manager</p>
                    </div>
                    ...
                    <div className="bg-black bg-opacity-50 p-2 text-center">
                        ...
                        <p className="text-xl text-gray-300 pb-10">Marketing Manager</p>
                    </div>
                </div>
            </div>
        </section>
